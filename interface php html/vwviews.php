...
if($view_name == 'wlasciciele') {
	...
	$query = mysql_query ("SHOW COLUMNS FROM view_wlasciciele");
		if(mysql_num_rows($query))
		{
			...
			if(mysql_num_rows($query2))
			{
				...
				echo '</tr>';
				echo '</table>';
				echo '<div style="text-align: center; min-height: 70px;">Brak rekordów w tabeli.<br><br> <a href="javascript: history.go(-1)" class="belka2">Powrót</a></div>';
			}
		} else {
	...
	echo '<div style="margin:24px;">';
		echo '<div style="text-align: center;">Wybierz widok, który chcesz zobaczyć.<br><br> <a href="vwviews.php?view=pracownicy" class="belka2">PRACOWNICY</a>    <a href="vwviews.php?view=wlasciciele" class="belka2">WŁAŚCICIELE</a>    <a href="vwviews.php?view=samochody" class="belka2">SAMOCHODY</a></div>';
