	...
	<div style="margin:24px; text-align: center;">
		...
		if($id == 1) {
			...
			if(mysql_num_rows($zapytanie))
			{
				...
				$insert_querry = mysql_query("INSERT INTO placowki (pl_id, pl_telefon, pl_fax, pl_godzina_otwarcia, pl_godzina_zamkniecia, ad_id) VALUES (001, '525362425', '426362172314', '09:00', '20:00', 001)");
				$insert_querry = mysql_query("INSERT INTO placowki (pl_id, pl_telefon, pl_fax, pl_godzina_otwarcia, pl_godzina_zamkniecia, ad_id) VALUES (002, '738262342', '172373264132', '09:00', '20:00', 002)");
				$insert_querry = mysql_query("INSERT INTO placowki (pl_id, pl_telefon, pl_fax, pl_godzina_otwarcia, pl_godzina_zamkniecia, ad_id) VALUES (003, '527424523', '183729528416', '09:00', '20:00', 003)");
				$insert_querry = mysql_query("INSERT INTO placowki (pl_id, pl_telefon, pl_fax, pl_godzina_otwarcia, pl_godzina_zamkniecia, ad_id) VALUES (004, '472341532', '103920012312', '09:00', '20:00', 004)");
				$insert_querry = mysql_query("INSERT INTO placowki (pl_id, pl_telefon, pl_fax, pl_godzina_otwarcia, pl_godzina_zamkniecia, ad_id) VALUES (005, '013024023', '015230140231', '09:00', '20:00', 005)");
				$insert_querry = mysql_query("INSERT INTO placowki (pl_id, pl_telefon, pl_fax, pl_godzina_otwarcia, pl_godzina_zamkniecia, ad_id) VALUES (006, '613623413', '093294199132', '09:00', '20:00', 006)");
				$insert_querry = mysql_query("INSERT INTO placowki (pl_id, pl_telefon, pl_fax, pl_godzina_otwarcia, pl_godzina_zamkniecia, ad_id) VALUES (007, '091224123', '523468320012', '09:00', '20:00', 007)");
				$insert_querry = mysql_query("INSERT INTO placowki (pl_id, pl_telefon, pl_fax, pl_godzina_otwarcia, pl_godzina_zamkniecia, ad_id) VALUES (008, '845630243', '243676800935', '09:00', '20:00', 008)");
				$insert_querry = mysql_query("INSERT INTO placowki (pl_id, pl_telefon, pl_fax, pl_godzina_otwarcia, pl_godzina_zamkniecia, ad_id) VALUES (009, '234978123', '098867534312', '09:00', '20:00', 009)");
				$insert_querry = mysql_query("INSERT INTO placowki (pl_id, pl_telefon, pl_fax, pl_godzina_otwarcia, pl_godzina_zamkniecia, ad_id) VALUES (010, '012652334', '053420981233', '09:00', '20:00', 010)");
				$insert_querry = mysql_query("INSERT INTO placowki (pl_id, pl_telefon, pl_fax, pl_godzina_otwarcia, pl_godzina_zamkniecia, ad_id) VALUES (011, '854641234', '865412343252', '09:00', '20:00', 011)");
				$insert_querry = mysql_query("INSERT INTO placowki (pl_id, pl_telefon, pl_fax, pl_godzina_otwarcia, pl_godzina_zamkniecia, ad_id) VALUES (012, '710231632', '123465410067', '09:00', '20:00', 012)");
				$insert_querry = mysql_query("INSERT INTO placowki (pl_id, pl_telefon, pl_fax, pl_godzina_otwarcia, pl_godzina_zamkniecia, ad_id) VALUES (013, '182530142', '736091724234', '09:00', '20:00', 013)");
				$insert_querry = mysql_query("INSERT INTO placowki (pl_id, pl_telefon, pl_fax, pl_godzina_otwarcia, pl_godzina_zamkniecia, ad_id) VALUES (014, '174523443', '123543564578', '09:00', '20:00', 014)");
				$insert_querry = mysql_query("INSERT INTO placowki (pl_id, pl_telefon, pl_fax, pl_godzina_otwarcia, pl_godzina_zamkniecia, ad_id) VALUES (015, '423432613', '534512376546', '09:00', '20:00', 015)");
				...
				$insert_querry = mysql_query("INSERT INTO dane_pojazdow (dp_id, dp_paliwo, dp_przebieg, dp_pojemnosc, dp_moc_km, dp_moc_kw, dp_masa_wlasna, dp_skrzynia_biegow) VALUES (001,'Benzyna',200900,'2.0',150,129,1654300,'manualna')");
				$insert_querry = mysql_query("INSERT INTO dane_pojazdow (dp_id, dp_paliwo, dp_przebieg, dp_pojemnosc, dp_moc_km, dp_moc_kw, dp_masa_wlasna, dp_skrzynia_biegow) VALUES (002,'Diesel',150500,'1.6',98,60,1300000,'manualna')");
				$insert_querry = mysql_query("INSERT INTO dane_pojazdow (dp_id, dp_paliwo, dp_przebieg, dp_pojemnosc, dp_moc_km, dp_moc_kw, dp_masa_wlasna, dp_skrzynia_biegow) VALUES (003,'Benzyna',180490,'1.8',180,150,2100000,'automatyczna')");
				$insert_querry = mysql_query("INSERT INTO dane_pojazdow (dp_id, dp_paliwo, dp_przebieg, dp_pojemnosc, dp_moc_km, dp_moc_kw, dp_masa_wlasna, dp_skrzynia_biegow) VALUES (004,'Diesel',250420,'1.0',101,70,1800000,'manualna')");
				$insert_querry = mysql_query("INSERT INTO dane_pojazdow (dp_id, dp_paliwo, dp_przebieg, dp_pojemnosc, dp_moc_km, dp_moc_kw, dp_masa_wlasna, dp_skrzynia_biegow) VALUES (005,'Benzyna',56000,'2.5',260,225,1760000,'automatyczna')");
				$insert_querry = mysql_query("INSERT INTO dane_pojazdow (dp_id, dp_paliwo, dp_przebieg, dp_pojemnosc, dp_moc_km, dp_moc_kw, dp_masa_wlasna, dp_skrzynia_biegow) VALUES (006,'Benzyna',170800,'1.6',95,66,1500000,'manualna')");
				$insert_querry = mysql_query("INSERT INTO dane_pojazdow (dp_id, dp_paliwo, dp_przebieg, dp_pojemnosc, dp_moc_km, dp_moc_kw, dp_masa_wlasna, dp_skrzynia_biegow) VALUES (007,'Benzyna',280800,'1.0',82,55,1320000,'manualna')");
				$insert_querry = mysql_query("INSERT INTO dane_pojazdow (dp_id, dp_paliwo, dp_przebieg, dp_pojemnosc, dp_moc_km, dp_moc_kw, dp_masa_wlasna, dp_skrzynia_biegow) VALUES (008,'Diesel',290500,'1.6',101,73,1890000,'manualna')");
				$insert_querry = mysql_query("INSERT INTO dane_pojazdow (dp_id, dp_paliwo, dp_przebieg, dp_pojemnosc, dp_moc_km, dp_moc_kw, dp_masa_wlasna, dp_skrzynia_biegow) VALUES (009,'Diesel',320300,'1.0',66,38,1430000,'manualna')");
				$insert_querry = mysql_query("INSERT INTO dane_pojazdow (dp_id, dp_paliwo, dp_przebieg, dp_pojemnosc, dp_moc_km, dp_moc_kw, dp_masa_wlasna, dp_skrzynia_biegow) VALUES (010,'Diesel',40000,'3.0',360,328,2500000,'automatyczna')");
				$insert_querry = mysql_query("INSERT INTO dane_pojazdow (dp_id, dp_paliwo, dp_przebieg, dp_pojemnosc, dp_moc_km, dp_moc_kw, dp_masa_wlasna, dp_skrzynia_biegow) VALUES (011,'Diesel',170400,'1.8',285,255,1670000,'automatyczna')");
				$insert_querry = mysql_query("INSERT INTO dane_pojazdow (dp_id, dp_paliwo, dp_przebieg, dp_pojemnosc, dp_moc_km, dp_moc_kw, dp_masa_wlasna, dp_skrzynia_biegow) VALUES (012,'Benzyna',120400,'3.5',325,290,1890000,'automatyczna')");
				$insert_querry = mysql_query("INSERT INTO dane_pojazdow (dp_id, dp_paliwo, dp_przebieg, dp_pojemnosc, dp_moc_km, dp_moc_kw, dp_masa_wlasna, dp_skrzynia_biegow) VALUES (013,'Diesel',190900,'1.2',180,152,1200000,'manualna')");
				$insert_querry = mysql_query("INSERT INTO dane_pojazdow (dp_id, dp_paliwo, dp_przebieg, dp_pojemnosc, dp_moc_km, dp_moc_kw, dp_masa_wlasna, dp_skrzynia_biegow) VALUES (014,'Benzyna',150390,'2.0',148,120,1340000,'automatyczna')");
				$insert_querry = mysql_query("INSERT INTO dane_pojazdow (dp_id, dp_paliwo, dp_przebieg, dp_pojemnosc, dp_moc_km, dp_moc_kw, dp_masa_wlasna, dp_skrzynia_biegow) VALUES (015,'Diesel',160600,'2.0',190,161,1540000,'automatyczna')");
				...
				$insert_querry = mysql_query("INSERT INTO wlasciciele (w_id, w_data_prawa_jazdy, w_waznosc_prawa_jazdy, w_ilosc_samochodow, w_procent_znizek_oc, if_id) VALUES (001, STR_TO_DATE('2002/04/29','%Y/%m/%d'), STR_TO_DATE('2026/05/19','%Y/%m/%d'),2,30,001)");
				$insert_querry = mysql_query("INSERT INTO wlasciciele (w_id, w_data_prawa_jazdy, w_waznosc_prawa_jazdy, w_ilosc_samochodow, w_procent_znizek_oc, if_id) VALUES (002, STR_TO_DATE('2001/05/21','%Y/%m/%d'), STR_TO_DATE('2026/03/11','%Y/%m/%d'),3,25,002)");
				$insert_querry = mysql_query("INSERT INTO wlasciciele (w_id, w_data_prawa_jazdy, w_waznosc_prawa_jazdy, w_ilosc_samochodow, w_procent_znizek_oc, if_id) VALUES (003, STR_TO_DATE('1999/08/19','%Y/%m/%d'), STR_TO_DATE('2021/11/13','%Y/%m/%d'),1,30,003)");
				$insert_querry = mysql_query("INSERT INTO wlasciciele (w_id, w_data_prawa_jazdy, w_waznosc_prawa_jazdy, w_ilosc_samochodow, w_procent_znizek_oc, if_id) VALUES (004, STR_TO_DATE('1980/03/13','%Y/%m/%d'), STR_TO_DATE('2030/02/01','%Y/%m/%d'),1,35,004)");
				$insert_querry = mysql_query("INSERT INTO wlasciciele (w_id, w_data_prawa_jazdy, w_waznosc_prawa_jazdy, w_ilosc_samochodow, w_procent_znizek_oc, if_id) VALUES (005, STR_TO_DATE('1989/03/06','%Y/%m/%d'), STR_TO_DATE('2029/11/09','%Y/%m/%d'),1,25,005)");
				$insert_querry = mysql_query("INSERT INTO wlasciciele (w_id, w_data_prawa_jazdy, w_waznosc_prawa_jazdy, w_ilosc_samochodow, w_procent_znizek_oc, if_id) VALUES (006, STR_TO_DATE('1995/11/23','%Y/%m/%d'), STR_TO_DATE('2035/05/19','%Y/%m/%d'),2,15,006)");
				$insert_querry = mysql_query("INSERT INTO wlasciciele (w_id, w_data_prawa_jazdy, w_waznosc_prawa_jazdy, w_ilosc_samochodow, w_procent_znizek_oc, if_id) VALUES (007, STR_TO_DATE('2002/03/29','%Y/%m/%d'), STR_TO_DATE('2028/10/13','%Y/%m/%d'),3,0,007)");
				$insert_querry = mysql_query("INSERT INTO wlasciciele (w_id, w_data_prawa_jazdy, w_waznosc_prawa_jazdy, w_ilosc_samochodow, w_procent_znizek_oc, if_id) VALUES (008, STR_TO_DATE('2001/02/23','%Y/%m/%d'), STR_TO_DATE('2026/01/30','%Y/%m/%d'),1,5,008)");
				$insert_querry = mysql_query("INSERT INTO wlasciciele (w_id, w_data_prawa_jazdy, w_waznosc_prawa_jazdy, w_ilosc_samochodow, w_procent_znizek_oc, if_id) VALUES (009, STR_TO_DATE('1996/03/19','%Y/%m/%d'), STR_TO_DATE('2026/05/29','%Y/%m/%d'),2,10,009)");
				$insert_querry = mysql_query("INSERT INTO wlasciciele (w_id, w_data_prawa_jazdy, w_waznosc_prawa_jazdy, w_ilosc_samochodow, w_procent_znizek_oc, if_id) VALUES (010, STR_TO_DATE('2001/12/23','%Y/%m/%d'), STR_TO_DATE('2023/12/11','%Y/%m/%d'),3,5,010)");
				$insert_querry = mysql_query("INSERT INTO wlasciciele (w_id, w_data_prawa_jazdy, w_waznosc_prawa_jazdy, w_ilosc_samochodow, w_procent_znizek_oc, if_id) VALUES (011, STR_TO_DATE('1992/04/13','%Y/%m/%d'), STR_TO_DATE('2022/05/29','%Y/%m/%d'),1,15,011)");
				$insert_querry = mysql_query("INSERT INTO wlasciciele (w_id, w_data_prawa_jazdy, w_waznosc_prawa_jazdy, w_ilosc_samochodow, w_procent_znizek_oc, if_id) VALUES (012, STR_TO_DATE('2001/11/09','%Y/%m/%d'), STR_TO_DATE('2023/04/14','%Y/%m/%d'),2,25,012)");
				$insert_querry = mysql_query("INSERT INTO wlasciciele (w_id, w_data_prawa_jazdy, w_waznosc_prawa_jazdy, w_ilosc_samochodow, w_procent_znizek_oc, if_id) VALUES (013, STR_TO_DATE('1993/11/13','%Y/%m/%d'), STR_TO_DATE('2032/05/03','%Y/%m/%d'),3,35,013)");
				$insert_querry = mysql_query("INSERT INTO wlasciciele (w_id, w_data_prawa_jazdy, w_waznosc_prawa_jazdy, w_ilosc_samochodow, w_procent_znizek_oc, if_id) VALUES (014, STR_TO_DATE('1994/07/29','%Y/%m/%d'), STR_TO_DATE('2031/09/09','%Y/%m/%d'),2,0,014)");
				$insert_querry = mysql_query("INSERT INTO wlasciciele (w_id, w_data_prawa_jazdy, w_waznosc_prawa_jazdy, w_ilosc_samochodow, w_procent_znizek_oc, if_id) VALUES (015, STR_TO_DATE('1993/03/13','%Y/%m/%d'), STR_TO_DATE('2028/09/03','%Y/%m/%d'),1,30,015)");
